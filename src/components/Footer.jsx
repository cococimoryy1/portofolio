...
import { VscHome, VscArchive, VscAccount, VscBook } from "react-icons/vsc"; // <-- Tambah import VscBook
...
const Footer = () => {
  const items = [
    ...
    { icon: <VscBook size={18} />, label: "Academic", onClick: () => document.getElementById("academic")?.scrollIntoView({ behavior: "smooth" }) }, // <-- Udah ada, cuma fix ikon
  ];
    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/cococimoryy1"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/shelyynra/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.youtube.com/@shelynariska7677"><i className="ri-youtube-fill ri-2x"></i></a>
        </div>
