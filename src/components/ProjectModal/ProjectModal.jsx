    ...
    {project.url && (
      ...
      {project.demoUrl && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-flex items-center justify-center gap-2 font-semibold bg-indigo-600 p-3 px-5 rounded-full w-full cursor-pointer border border-transparent hover:bg-indigo-700 transition-colors"
        >
      ...
      {project.downloadUrl && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-flex items-center justify-center gap-2 font-semibold bg-emerald-600 p-3 px-5 rounded-full w-full cursor-pointer border border-transparent hover:bg-emerald-700 transition-colors"
        >
